...
class Board(models.Model):
    ...
    # TODO remove the access code/ will use invitations to boards
...
class UserProfile(models.Model):
    ...
    board = models.ForeignKey(Board, on_delete=models.SET_NULL, default=None, null=True)
...
class Task(models.Model):
    ...
    status_choices = [("todo", "To Do"), ("wip", "In Progress"), ("done", "Done")]

    board = models.ForeignKey(Board, on_delete=models.CASCADE)
    assigned_to = models.ForeignKey(User, on_delete=models.SET_NULL, null=True)
    priority = models.CharField(
        choices=priority_choices, default=MEDIUM, blank=True, max_length=1
    )
