...
urlpatterns = [
    ...
    path(
        "user_profile/<int:pk>/", views.UserProfileView.as_view(), name="user_profile"
    ),
    # path('edit_task/<int:task_id>/', views.EditTaskView.as_view(), name='edit_task'),
    path("register/", views.RegisterView.as_view(), name="register"),
    path("about/", views.AboutView.as_view(), name="about"),
    path(
        "add_task_success/", views.AddTaskSuccessView.as_view(), name="add_task_success"
    ),
    ...
    path(
        "resign_task/<int:task_id>", views.ResignTaskView.as_view(), name="resign_task"
    ),
